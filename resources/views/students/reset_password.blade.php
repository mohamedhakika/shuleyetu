    ...
    <div class="col-lg-8 col-lg-offset-2 col-md-12">
      <div class="card" style="min-height: 485px">
        <div class="header card-header-text">
          <h4 class="title"><i class="ti-user"></i> Reset <strong>{{ $student->user->name }}</strong> Password
          <a href="{{route('students.o-level')}}" class="btn btn-info pull-right"><i class="fa fa-mail-reply"></i> Back </a>
          </h4>
        </div>
        <div class="content">
